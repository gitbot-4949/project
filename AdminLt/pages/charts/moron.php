        ...
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Turn Over Chart </h3>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">GST Collection Chart</h3>
...
}else
{
    ...
    $result = mysqli_query($con, "select date_format(created,'%b') 'Months',sum(totalamount) 'Turnover' from invtest2 WHERE YEAR(created) = YEAR(CURDATE()) group by year(created),month(created) order by year(created),month(created)");
