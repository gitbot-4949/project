...
if(isset($_POST['profilesubmit']))
{
  ...
  $update=mysqli_query($con,"update admin set name='$name', email='$email',qualification='$qualification',
    location='$location',profession='$profession' where id= 1") or die("error".mysqli_error($con));

 // echo "update admin set name='$name', email='$email',qualification='$qualification',
 //    location='$location',profession='$profession' where id= 1";
...
// $tags  = htmlspecialchars_decode($tags);
  ...
  $update=mysqli_query($con,"update admin set c_name='$cname',c_add='$cadd', mob='$cmob', email='$cemail', gst='$cgst' where id= 1") or die("error".mysqli_error($con));
...
//After completion of image upload process
function completeUpload2(success, fileName) {
  if(success == 1){
    $('#imagePreviewc').attr("src", "");
    $('#imagePreviewc').attr("src", fileName);
...
<body class="hold-transition skin-blue sidebar-mini" onload="scrollTo(0,0)">
<div class="wrapper">
...
//User profile picture
$userPicture2 = !empty($row['picture'])?$row['picture']:'no-image.png';
$userPictureURL2 = 'uploads/images/logo/'.$userPicture;
...
<br/>
 ...
 id="inputSkills" data-role="tagsinput"  placeholder="Skills">
                    </div>
                  </div>
 -->
               <br/>
        ...
        <input type="file" name="picture" id="fileInput2"  style="display:none"/>
      </form>
    ...
    <div class="overlay uploadProcess" style="display: none;">
      ...
      <!-- Image update link -->
      <div align="center">
           <a class="editLink2" style="z-index: -1;padding-left: 150px;"><img src="../dist/img/images/edit.png"/></a>
         </div>

                      <img class="profile-user-img img-responsive img-circle" src="<?php echo $userPictureURL2; ?>" id="imagePreviewc"
                       style="height: 150px; width:150px; z-index: -1;" alt="User profile picture">
               ...
               <div class="form-group">
                   ...
                   <div class="col-sm-10">
                     <input type="text" class="form-control" id="inputcom" name="cgst"  
...
<script type="text/javascript">
  ...
  function validate(){
    ...
    var cpass= document.getElementById("cpassword").value;
     ...
     if(!pass)
  {
    document.getElementById("passerror").innerHTML="Enter New Password";
