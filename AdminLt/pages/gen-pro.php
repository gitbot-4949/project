...
if(isset($_POST['submit']))
{
 ...
 // echo "\n Client id".$data2[0];
  $fg2=$data2[0];
    ...
    $date= date("Y-m-d");
//$id=$_POST['cid'];
   $stm=mysqli_query($con, "insert into protest2(invid,cid, orderid,totalitems,subtotal,taxrate,taxamount,totalamount,created) values ('$invid','$fg2','$orderid','$itemCount','$subTotal','$taxRate','$taxAmount','$totalAftertax','$date')");

 // echo "insert into protest2(invid,cid, orderid,totalitems,subtotal,taxrate,taxamount,totalamount,created) values ('$invid','$fg2','$orderid','$itemCount','$subTotal','$taxRate','$taxAmount','$totalAftertax','$date')";
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="client" class="form-control select2" required="required" onchange="showCustomer(this.value)" style="height:34px;width: 80%;border-radius:0px;padding: 6px 12px !important; ">
                                 <option></option>
...
<hr>
      ...
      <tr>
        ...
        <td><select name="item_name[]" id="productName_1" class="form-control item_unit" required="required" onchange="showproduct(this.value)"><option value="">Select Unit</option>
...
document.getElementById("damount").value=tax;
 ...
 $(document).on('click', '.add', function(){
  ...
  html += '<td><select name="item_name[]" id="productName_'+count+'" class="form-control item_unit" required="required" onchange="showproduct(this.value)"><option value="">Select Unit</option><?php echo fill_unit_select_box($connect); ?></select></td>';
