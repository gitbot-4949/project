...
// echo "SELECT invtest2.invid, invtest2.orderid,client.c_name,client.c_add,client.mob,client.gst,client.c_type,invtest2.created, invtest2.subtotal,invtest2.taxrate,invtest2.taxamount,invtest2.totalamount FROM `invtest2`join client where invtest2.cid=client.cid and invid='$val'";
